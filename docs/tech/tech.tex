...
Poliscope：七人科学议会、双图证据治理\\与计算社会科学盲点发现智能体\par}
\vspace{0.9cm}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=south west, text=white!55, font=\sffamily\footnotesize]
    ...
    {配套学术论文：《EpistemoBrain: Generalizing Executive Memory to Multi-Agent Systems》（ACL Findings 2026 格式，源码见 docs/paper/）};
\end{tikzpicture}
\end{titlepage}
