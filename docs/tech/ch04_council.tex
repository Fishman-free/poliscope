...
\item \textbf{盲点悬赏。}证据图暴露的缺口生成盲点候选，按五项加权求和打分：影响 $0.30$、不确定性 $0.25$、可调查性 $0.20$、新颖度 $0.15$、成本（取 $1-$ 归一化成本）$0.10$；再按分数排出优先级，分派给\textbf{全部七席}——同一条盲点，七席各按固定的角色角度同时调查，不是「一人认领一条」。
